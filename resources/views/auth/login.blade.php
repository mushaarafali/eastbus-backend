    ...
    <style>
        * {
        ...
        body.auth-page {
            ...
            background:
                radial-gradient(circle at top left, rgba(14, 88, 220, 0.14), transparent 34%),
                radial-gradient(circle at bottom right, rgba(15, 42, 91, 0.12), transparent 32%),
                linear-gradient(135deg, #f8fbff 0%, #eef4ff 50%, #f7f9fd 100%);
            display: flex;
        ...
        .auth-card {
            ...
            box-shadow: 0 25px 70px rgba(26, 54, 107, 0.15), 0 8px 25px rgba(26, 54, 107, 0.08);
    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <div class="register-box">
                ...
                <a href="{{ route('operator.register') }}">Register Operator</a>
            </div>
